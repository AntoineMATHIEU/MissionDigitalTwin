 ...
 *   <li>{@link dtmodel.impl.ConnectorEndImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConnectorEndImpl extends MinimalEObjectImpl.Container implements ConnectorEnd {
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DtmodelPackage.CONNECTOR_END__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case DtmodelPackage.CONNECTOR_END__PORT:
			if (resolve)
				return getPort();
			return basicGetPort();
		case DtmodelPackage.CONNECTOR_END__NAME:
			return getName();
		}
