...
public class DtmodelPackageImpl extends EPackageImpl implements DtmodelPackage {
	 ...
	 * @generated
	 */
	public EAttribute getConnectorEnd_Name() {
	...
	public void createPackageContents() {
		...
		createEAttribute(connectorEndEClass, CONNECTOR_END__NAME);
	...
	public void initializePackageContents() {
		...
		initEReference(getConnectorEnd_Port(), this.getPort(), this.getPort_Connectorend(), "port", null, 0, 1,
				...
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getConnectorEnd_Name(), ecorePackage.getEString(), "name", null, 0, 1, ConnectorEnd.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
