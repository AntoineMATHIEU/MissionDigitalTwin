...
public class DTPackageImpl extends EPackageImpl implements DTPackage {
	...
	public static DTPackage init() {
		if (isInited)
			return (DTPackage) EPackage.Registry.INSTANCE.getEPackage(DTPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredDTPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		DTPackageImpl theDTPackage = registeredDTPackage instanceof DTPackageImpl ? (DTPackageImpl) registeredDTPackage
				: new DTPackageImpl();
	...
	public void initializePackageContents() {
		...
		initEClass(componentEClass, Component.class, "Component", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getComponent_Port(), this.getPort(), this.getPort_Component(), "port", null, 0, 1,
		...
		initEClass(connectorEndEClass, ConnectorEnd.class, "ConnectorEnd", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getConnectorEnd_Port(), this.getPort(), null, "port", null, 0, 1, ConnectorEnd.class,
		...
		initEReference(getPort_Component(), this.getComponent(), this.getComponent_Port(), "component", null, 0, 1,
